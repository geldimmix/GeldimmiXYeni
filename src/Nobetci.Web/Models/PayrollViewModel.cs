...
public class PayrollViewModel
{
    ...
    public decimal WeeklyRequiredHours { get; set; } = 45;
...
public class EmployeePayroll
{
    ...
    public int TotalWorkDays { get; set; }  // Expected work days in month
    
    // Hours
    public decimal TotalWorkedHours { get; set; }
    public decimal RequiredHours { get; set; }  // Hours they should have worked
    public decimal OvertimeHours => Math.Max(0, TotalWorkedHours - RequiredHours);
    public decimal UnderHours => Math.Max(0, RequiredHours - TotalWorkedHours);
